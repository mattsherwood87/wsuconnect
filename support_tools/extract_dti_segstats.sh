...
printf "%g," `grep -w ${x} ${ses_num}/segstats/dwi/${subj}_${ses}_proc-flirt_res-hi_space-individual_desc-iout-tmean-brain_dwi_MD-1000.dat | grep -v lobe | awk '{print $6}'` >> CorticalMeasuresENIGMA_mean.csv
