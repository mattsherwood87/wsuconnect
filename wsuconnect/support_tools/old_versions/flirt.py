    ...
    try:
        ...
        if refImageFile:
            ...
            if os.path.isfile(flt.inputs.out_matrix_file) and not overwriteFlag:
                ...
                if progress:
                    os.system('echo "Performing FLIRT:"')
                    os.system('echo "\tInput File: ' + flt.inputs.in_file + '"')
                    os.system('echo "\tReference: ' + flt.inputs.reference + '"')
                    os.system('echo "\tOut File: ' + flt.inputs.out_file + '"')
                    os.system('echo "\tOut Matrix File: ' + flt.inputs.out_matrix_file + '"')
                flt.run()
                if progress:
            ...
            if not refImageParams['type'] == "std" and stdImageFile:
                ...
                if progress:
                    os.system('echo "Concatenating FLIRT transform with standard transform:"')
                    os.system('echo "\tInput File: ' + invt.inputs.in_file + '"')
                    os.system('echo "\tInput FIle 2: ' + invt.inputs.in_file2 + '"')
                    os.system('echo "\tOut File: ' + invt.inputs.out_file + '"')
