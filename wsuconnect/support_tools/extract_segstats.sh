...
#echo 'SubjID,CC_Mid_Anterior,CC_Mid_Posterior,CA1,CA1-head,CA1-body,CA2,CA2-head,CA2-body,CA3,CA3-head,CA3-body,CA4,CA4-head,CA4-body,Left-Hippocampus,Right-Hippocampus,Left-Putamen,Right-Putamen,Left-Pallidum,Right-Pallidum,Left-Caudate,Right-Caudate,Left-Locus-Coeruleus,Right-Locus-Coeruleus,Left-Amygdala,Left-Amygdala-Anterior,Right-Amygdala,Right-Amygdala-Anterior,ctx-lh-superiorparietal,ctx-rh-superiorparietal,ctx-lh-superiortemporal,ctx-rh-superiortemporal,Left-Insula,ctx-lh-insula,ctx-lh-insula-lobe,ctx-lh-S_central_insula,ctx-lh-S_circular_insula_anterior,ctx-lh-S_circular_insula_inferior,ctx-lh-S_circular_insula_superior,Right-Insula,ctx-rh-insula,Amygdala' > CorticalMeasuresENIGMA_mean.csv
echo 'SubjID,Left-Hippocampus,Right-Hippocampus,Left-Amygdala,Left-Amygdala-Anterior,Right-Amygdala,Right-Amygdala-Anterior' > CorticalMeasuresENIGMA_volume.csv
...
printf "%s,"  "${ses}" >> CorticalMeasuresENIGMA_volume.csv
...
#for x in CC_Mid_Anterior CC_Mid_Posterior CA1 CA1-head CA1-body CA2 CA2-head CA2-body CA3 CA3-head CA3-body CA4 CA4-head CA4-body Left-Hippocampus Right-Hippocampus Left-Putamen Right-Putamen Left-Pallidum Right-Pallidum Left-Caudate Right-Caudate Left-Locus-Coeruleus Right-Locus-Coeruleus Amygdala Left-Amygdala Left-Amygdala-Anterior Right-Amygdala Right-Amygdala-Anterior ctx-lh-superiorparietal ctx-rh-superiorparietal ctx-lh-superiortemporal ctx-rh-superiortemporal Left-Insula ctx-lh-insula ctx-lh-insula-lobe ctx-lh-S_central_insula ctx-lh-S_circular_insula_anterior ctx-lh-S_circular_insula_inferior ctx-lh-S_circular_insula_superior Right-Insula ctx-rh-insula; do
for x in Left-Hippocampus Right-Hippocampus Left-Amygdala Left-Amygdala-Anterior Right-Amygdala Right-Amygdala-Anterior; do
#printf "%g," `grep -w ${x} ${ses_num}/segstats/perf/${subj}_${ses}_acq-source_task-rest_proc-flirt_res-hi_space-individual_desc-vol-1-brain_cbf.dat | grep -v lobe | awk '{print $6}'` >> CorticalMeasuresENIGMA_mean.csv
printf "%g," `grep -w ${x} ${ses_num}/stats/aseg.stats | grep -v lobe | awk '{print $4}'` >> CorticalMeasuresENIGMA_volume.csv
...
echo "" >> CorticalMeasuresENIGMA_volume.csv
